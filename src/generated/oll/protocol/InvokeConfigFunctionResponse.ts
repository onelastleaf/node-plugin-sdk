...
export interface InvokeConfigFunctionResponse {
  'results'?: (_oll_protocol_ConfigValue)[];
}

export interface InvokeConfigFunctionResponse__Output {
  'results'?: (_oll_protocol_ConfigValue__Output)[];
}
